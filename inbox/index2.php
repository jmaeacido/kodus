                ...
                <div class="message-list" id="messageList">
                  ...
                  <?php else: ?>
                    <div class="empty-inbox text-center p-4">
                      <img src="<?php echo $app_root; ?>dist/img/empty-inbox.png" alt="Empty Inbox" style="max-width:150px; opacity:0.6;">
              ...
              <div class="message-detail" id="messageDetail">
                ...
                <?php else: ?>
                  <div class="empty-detail text-center p-4">
                    <!-- <img src="<?php echo $app_root; ?>dist/img/empty-detail.png" 
