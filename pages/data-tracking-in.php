        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="table-container kodus-table-scroll" style="--kodus-table-min-width: 1200px;">
              <table id="incoming-table" class="table table-bordered table-striped" style="text-align: center; width: 100%; table-layout: auto;">
    ...
    Swal.fire({
      ...
      let table = $("#incoming-table").DataTable({
          ...
          "columnDefs": [
              ...
              { "targets": 7, "width": "8rem" },
              { "targets": 8, "width": "7rem" }
          ],
...
$(document).on("click", ".forward-btn", function() {
    ...
    Swal.fire({
        ...
        html: renderFriendlyFormShell({
            ...
            sections: `
                <div class="kodus-form-section">
                    ...
                    ${renderUploadProgress('forwardProgress')}
                </div>
            `
        }),
        showCancelButton: true,
        ...
        preConfirm: () => {
            ...
            return submitFormDataWithProgress("forward_document.php", formData, "forwardProgress", {
                preparing: "Preparing document forwarding",
                transferring: "Forwarding document",
                processing: "Finalizing forwarding"
            })
            .then(data => {
    ...
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            return submitFormDataWithProgress("track_incoming.php", formData, "trackUploadProgress", {
                ...
                transferring: "Saving document",
                processing: "Finishing document tracking"
            })
            .then(data => {
                if (!data.success) {
                    throw new Error(data.message);
