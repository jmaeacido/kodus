...
$columns = [null, 'date_received', 'tracking_number', 'description', 'remarks', 'file_name', 'focal', 'user_log', 'status'];
...
// =======================
$sql_total = "SELECT COUNT(*) AS total FROM incoming WHERE YEAR(date_received) = ?";
