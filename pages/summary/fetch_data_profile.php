...
// Columns
$columns = ['id', 'lastName', 'firstName', 'middleName', 'ext', 'purok', 'barangay', 'lgu', 'province', 'birthDate', 'age', 'sex', 'civilStatus', 'nhts1', 'nhts2', 'fourPs', 'F', 'FF', 'IS', 'IP', 'SC', 'SP', 'LW', 'PW', 'PWD', 'OSY', 'FR', 'ybDs', 'lgbtqia'];
