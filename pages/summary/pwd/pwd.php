                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        foreach ($rows as $row) {
                            ...
                            $total_male += (int) ($row['male_pwd_count'] ?? 0);
                            $total_female += (int) ($row['female_pwd_count'] ?? 0);
                            $total_A += (int) ($row['A_count'] ?? 0);
                            $total_B += (int) ($row['B_count'] ?? 0);
                            $total_C += (int) ($row['C_count'] ?? 0);
                            $total_D += (int) ($row['D_count'] ?? 0);
                            $total_E += (int) ($row['E_count'] ?? 0);
                            $total_F += (int) ($row['F_count'] ?? 0);
                            $total_G += (int) ($row['G_count'] ?? 0);
                            $total_H += (int) ($row['H_count'] ?? 0);
                            $total_I += (int) ($row['I_count'] ?? 0);
                            $total_J += (int) ($row['J_count'] ?? 0);
                            $total_K += (int) ($row['K_count'] ?? 0);
                        }
                        ?>
