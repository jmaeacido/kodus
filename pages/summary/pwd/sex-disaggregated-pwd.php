                  ...
                  <table id="sectoralTable" class="table table-bordered table-striped" style="text-align: center; width: 100%; table-layout: auto;">
                    <thead>
                      ...
                      <tr>
                        ...
                        foreach ($rows as $row) {
                            $total_pwd += (int) ($row['pwd_count'] ?? 0);
                            $total_female_A += (int) ($row['male_A_count'] ?? 0);
                            $total_male_A += (int) ($row['female_A_count'] ?? 0);
                            $total_female_B += (int) ($row['male_B_count'] ?? 0);
                            $total_male_B += (int) ($row['female_B_count'] ?? 0);
                            $total_female_C += (int) ($row['male_C_count'] ?? 0);
                            $total_male_C += (int) ($row['female_C_count'] ?? 0);
                            $total_female_D += (int) ($row['female_D_count'] ?? 0);
                            $total_male_D += (int) ($row['male_D_count'] ?? 0);
                            $total_female_E += (int) ($row['female_E_count'] ?? 0);
                            $total_male_E += (int) ($row['male_E_count'] ?? 0);
                            $total_female_F += (int) ($row['female_F_count'] ?? 0);
                            $total_male_F += (int) ($row['male_F_count'] ?? 0);
                            $total_female_G += (int) ($row['female_G_count'] ?? 0);
                            $total_male_G += (int) ($row['male_G_count'] ?? 0);
                            $total_female_H += (int) ($row['female_H_count'] ?? 0);
                            $total_male_H += (int) ($row['male_H_count'] ?? 0);
                            $total_female_I += (int) ($row['female_I_count'] ?? 0);
                            $total_male_I += (int) ($row['male_I_count'] ?? 0);
                            $total_female_J += (int) ($row['female_J_count'] ?? 0);
                            $total_male_J += (int) ($row['male_J_count'] ?? 0);
                            $total_female_K += (int) ($row['female_K_count'] ?? 0);
                            $total_male_K += (int) ($row['male_K_count'] ?? 0);
                        }
                        ?>
