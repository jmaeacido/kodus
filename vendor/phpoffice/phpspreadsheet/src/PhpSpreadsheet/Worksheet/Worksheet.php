...
class Worksheet
{
    ...
    public function rangeToArrayYieldRows(
        ...
        $hiddenColumns = [];
        $nullRow = $this->buildNullRow($nullValue, $minColInt, $maxColInt, $returnCellRef, $ignoreHidden, $hiddenColumns);
     ...
     * @param int $minColInt Start column index of the range
     * @param int $maxColInt End column index of the range
     * @param bool $returnCellRef False - Return a simple array of rows and columns indexed by number counting from zero
     *                              True - Return rows and columns indexed by their actual row and column IDs
     * @param bool $ignoreHidden False - Return values for rows/columns even if they are defined as hidden.
     *                             True - Don't return values for rows/columns that are defined as hidden.
    ...
    private function buildNullRow(
        ...
        $nullRow = [];
        $c = -1;
        for ($columnIndex = $minColInt; $columnIndex <= $maxColInt; ++$columnIndex) {
